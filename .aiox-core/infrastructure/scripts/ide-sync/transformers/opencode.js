/**
 * OpenCode Transformer - OpenCode CLI agent format
 * @story OpenCode-Integration - AIOX OpenCode CLI Support
 *
 * Format: Markdown with agent persona, quick commands, and collaboration info
 * Target: .opencode/agents/*.md
 *
 * OpenCode supports:
 * - AGENTS.md for project-level instructions
 * - .opencode/commands/*.md for custom commands (with frontmatter)
 * - Agent system with system prompts and tool access
 * This transformer generates agent files that can be referenced by OpenCode.
 */
...
function transform(agentData) {
  ...
  // Build content — OpenCode-optimized markdown
...
`;
  ...
  // Add all commands for reference (full listing)
